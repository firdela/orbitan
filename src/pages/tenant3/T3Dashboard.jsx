...
export default function T3Dashboard() {
  return (
    <AppShell navigation={NAV} tenant={TENANT} title="" headerRight={<div className="flex items-center gap-2"><ShieldStatusWidget status="healthy" compact /><NotificationsInbox tenantSlug="t3" /><TenantSwitcher /></div>}>
