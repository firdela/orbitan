    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Background jobs, worker logs, system events, and application errors",
          permission: "admin",
        },
        {
          key: "deployment-pipeline",
          label: "Deployment Pipeline",
          route: "/platform/deployment-pipeline",
          description: "Development, testing, staging, production environments and release history",
          permission: "admin",
        },
        {
          key: "tenant-metrics",
          label: "Tenant Metrics",
          route: "/platform/tenant-metrics",
          description: "Platform-wide analytics: tenant growth, usage, subscriptions, and revenue",
          permission: "admin",
        },
        {
          key: "security-dashboard",
          label: "Security Dashboard",
          route: "/platform/security-dashboard",
          description: "Security events, failed logins, suspicious activity, and threat indicators",
          permission: "admin",
        },
        {
          key: "feature-flags",
          ...
          description: "Module activation per tenant — integrates with Capability Manager and RBAC",
          permission: "admin",
        },
        {
          key: "change-log",
          label: "Change Log",
          route: "/platform/change-log",
          description: "New features, improvements, bug fixes, and known issues across all releases",
          permission: "admin",
        },
      ],
    },
