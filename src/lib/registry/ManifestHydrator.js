...
const FALLBACK_NAV = [
  ...
  { id: 'production', label: 'Production', icon: 'ChefHat', route: '/production', module_key: 'production', isLocked: false },
  ...
  { id: 'finance-integration', label: 'Finance Integration', icon: 'DollarSign', route: '/finance-integration', module_key: 'finance_integration', isLocked: false },
  ...
  { id: 'nexus-intelligence', label: 'Orbit Nexus Intelligence', icon: 'Zap', route: '/nexus-intelligence', module_key: 'nexus_intelligence', isLocked: false },
...
const STANDARD_WORKSPACE_MODULES = [
  ...
  { section: 'Finance', id: 'finance-integration', label: 'Finance Integration', icon: 'DollarSign', routeSuffix: '/finance-integration', moduleKey: 'finance_integration' },
  { section: 'Operations', id: 'production', label: 'Production', icon: 'ChefHat', routeSuffix: '/production', moduleKey: 'production' },
  { section: 'Operations', id: 'clients', label: 'Clients', icon: 'Store', routeSuffix: '/clients', moduleKey: 'clients' },
  { section: 'Insights & Compliance', id: 'nexus-intelligence', label: 'Orbit Nexus Intelligence', icon: 'Zap', routeSuffix: '/nexus-intelligence', moduleKey: 'nexus_intelligence' },
