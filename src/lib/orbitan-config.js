...
export const SUBSCRIPTION_PLANS = {
  ...
  orbitan_starter: {
    ...
    color_hex: "#2563EB",
    allowed_modules: ["workforce", "scheduling", "task", "reporting"],
    allowed_packs: [],
    pack_limit: 0,
    ai_access: false,
    advanced_reporting: false,
  ...
  orbitan_growth: {
    ...
    color_hex: "#10B981",
    allowed_modules: ["workforce", "scheduling", "task", "inventory", "procurement", "compliance", "reporting", "expenses"],
  ...
  orbitan_business: {
    ...
    color_hex: "#7C3AED",
    allowed_modules: ["workforce", "scheduling", "task", "inventory", "procurement", "compliance", "reporting", "sales_invoice", "finance_integration", "customer_management", "expenses", "sustainability"],
...
export const LAUNCH_TENANTS = {
  ...
  renewed_fashion: {
    ...
    currency: "SGD",
    status: "onboarding",
    notes: "Not yet incorporated as Pte Ltd. In planning & development phase. Brand and outlet structure to be established. Future focus: sourcing, repurposing, recycling & redistributing reusable clothing.",
  },
  izaliqa_bakes: {
    ...
    outlets: ["Primary Home Operation"],
    enabled_modules: ["task", "inventory", "procurement", "sales_invoice", "compliance", "expenses", "sustainability"],
    enabled_packs: ["core", "fnb"],
    manifest_key: "hbb_ops_v1",
    country: "Singapore",
    currency: "SGD",
    status: "onboarding",
    notes: "Home-Based Business (HBB). Not yet incorporated. Operates from home — festive cookies, Hari Raya, Christmas & seasonal baked goods. Orbitan onboarding for operational convenience, planning & future growth.",
  },
};
