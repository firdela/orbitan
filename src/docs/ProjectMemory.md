...
6. **Stripe integration — ACTIVATING (2026-07-07):** Escalated to MVP must-have by Product Owner. Stripe payment provider installation initiated for subscription billing + wallet credit top-ups. Available natively in SG region.
