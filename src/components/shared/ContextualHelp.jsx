 ...
 *
 * The trigger is wrapped in a span with stopPropagation so clicks on the info
 * icon do NOT bubble to interactive parent cards (e.g. StatCard with `to`),
 * without calling preventDefault — which would interfere with Radix's own
